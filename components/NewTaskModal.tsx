  ...
  return (
    ...
    >
      <div
        ...
        className="bg-surface border border-border rounded-xl w-full max-w-md animate-fade-in"
      >
        ...
        <div className="p-5 flex flex-col gap-3.5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Reconcile weekend till reports"
              className={field}
            />
          </div>
          ...
          <div>
            ...
            {employeesQuery.isLoading && (
              <div className="text-[11.5px] text-faint">Loading people…</div>
            )}
          ...
          >
            <Plus size={15} /> {createTask.isPending ? 'Creating…' : 'Create & assign'}
          </button>
        </div>
      </div>
    </div>
